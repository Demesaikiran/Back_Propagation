...
This example project demonstrates how the gradient descent algorithm may be used to solve a linear regression problem. Remember, gradient descent is the optimization strategy, but when applied to neural networks, gradient descent is renamed backpropagation. For code on gradient descent applied to a neural network. 
